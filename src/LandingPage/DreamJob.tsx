  ...
  <div className="flex items-center px-16">
   <div className="flex flex-col w-[45%] gap-3">
    ...
    <div className="flex gap-3 mt-5">
     <TextInput 
      className="bg-mine-shaft-800 rounded-lg p-1 px-2 
      text-mine-shaft-100 [&_input]:text-mine-shaft-100"
      variant="unstyled"
      label="Job Title"
     ...
     bg-bright-sun-400 text-mine-shaft-100 rounded-lg
     p-2 hover:bg-bright-sun-500 cursor-pointer">
   ...
   <div className="w-[55%] flex items-center justify-center">
    <div className="w-[30rem] relative">
     ...
     backdrop-blur-md">
      ...
      <Avatar.Group>
       <Avatar src="vietnam-profile.jpg" />
       <Avatar src="vietnam-1.jpg" />
       <Avatar src="vietnam-3.jpg" />
       <Avatar>+9K</Avatar>
      </Avatar.Group>
     </div>

     <div className="absolute -left-5 w-fit top-[28%] border-bright-sun-400 border rounded-lg p-2
